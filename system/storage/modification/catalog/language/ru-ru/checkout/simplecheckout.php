<?php
$_['error_bb_pvz'] = 'Выберите пункт выдачи Boxberry'; 
// Heading 
$_['heading_title']                  = 'Оформление заказа (<a href="/kak-oformit-zakaz-na-saite-ita-group">Как оформить?</a>)';

				$_['return_guarantee']               = 'Гарантируем возврат денег, если запчасть не подошла!';
				$_['present_sale']                   = 'Дарим скидку на следующую покупку - ';
				$_['sale_quantity']                  = '7%';
				$_['sale_title']                     = 'Скидка предоставляется при 100% предоплате этого заказа. После оплаты вы получите смс с промокодом.';
...
$_['text_checkout_customer_login']   = 'Войти в личный кабинет';
$_['text_checkout_customer_cancel']  = 'Отмена';
$_['text_checkout_shipping_method']  = 'Способ доставки';
$_['text_checkout_shipping_pickup']  = 'Самовывоз';
$_['text_checkout_shipping_delivery']= 'Доставка';
$_['text_checkout_shipping_remont']  = 'Ремонт';
...
$_['error_filetype']                 = 'Недопустимый тип файла!';
				...
				$_['text_sale_quantity']             = 'При покупке 4-х товаров скидка 10%, 6-ти товаров - 15%';
