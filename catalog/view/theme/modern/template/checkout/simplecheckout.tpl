            ...
            <?php if (!$cart_empty) { ?>
                ...
                <div class="simplecheckout-button-block buttons" id="buttons">
                    <div class="simplecheckout-button-right">
					    <div class="simplecheckout-agreement_checkbox">
                        <?php if ($display_agreement_checkbox) { ?><span id="agreement_checkbox"><label><input type="checkbox" name="agreement" value="1" <?php if ($agreement == 1) { ?>checked="checked"<?php } ?> /><a href="/polzovatelskoe-soglashenie" title="Ознакомиться с пользовательским соглашением"><?php echo $text_agreement; ?></a></label>&nbsp;</span><?php } ?>
                        </div>
						<?php if ($steps_count > 1) { ?>
